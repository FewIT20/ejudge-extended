$( document ).ready(function() {
    ...
    if(window.location.href.includes("admin/courseproblem")) {
        ...
        $('#btn_copy_problem').click(function() {
            const problem_id = document.querySelector('input[name="problem_id"]').value;
    ...
    if(window.location.href.includes("problem")){
        ...
        //Show hidden editor for C and Python only
            ...
            $(".brython > .box > .box-header").append(
                "<button style='margin:10px' id='btn_editor_toggle' class='btn btn-warning pull-right'><i class='fa fa-upload'></i> Toggle Editor</button>"
            );
